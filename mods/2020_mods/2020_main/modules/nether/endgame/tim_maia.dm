...
/obj/screen/fullscreen/tim_maia
	icon = 'mods/2020_mods/2020_main/icons/effects/tim_maia.dmi'
	icon_state = "tim"
...
/datum/universal_state/tim_maia/OnEnter()
	...
	sound_to(world, sound('mods/2020_mods/2020_main/sounds/ambience/eu_so_quero_amar.ogg'))
...
/datum/universal_state/tim_maia/proc/announce_tim_invasion()
	...
	sound_to(world, sound('mods/2020_mods/2020_main/sounds/misc/nether_alarm.ogg'))
...
/datum/universal_state/tim_maia/proc/announce_destruction()
	...
	sound_to(world, sound('mods/2020_mods/2020_main/sounds/misc/suspense.ogg'))
...
/datum/universal_state/tim_maia/proc/jumpscare()
	for(var/mob/M in global.player_list)
		sound_to(M, sound('mods/2020_mods/2020_main/sounds/misc/scream.ogg'))
