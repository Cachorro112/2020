...
/obj/machinery/atmospherics/unary/cryo_cell
	name = "cryo cell"
	desc = "Uses a supercooled chemical bath to hold living beings in something close to suspended animation. Often paired with specialized medicines to rapidly heal wounds of a patient inside."
	icon = 'mods/content/2020_the_cold_war/icons/obj/cryo.dmi' //Map Only!
