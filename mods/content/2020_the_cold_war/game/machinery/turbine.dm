/obj/machinery/atmospherics/binary/pipeturbine
	name = "turbine"
...
/obj/machinery/atmospherics/binary/pipeturbine/Initialize()
	. = ..()
	air_in.volume = 200
	air_out.volume = 800
	volume_ratio = air_in.volume / (air_in.volume + air_out.volume)

/obj/machinery/atmospherics/binary/pipeturbine/get_initialize_directions()
	switch(dir)
		if(NORTH)
...
/obj/machinery/atmospherics/binary/pipeturbine/air_in_dir(direction)
...
/obj/machinery/atmospherics/binary/pipeturbine/Process()
	..()
...
/obj/machinery/atmospherics/binary/pipeturbine/on_update_icon()
	cut_overlays()
	if (dP > 10)
...
/obj/machinery/turbinemotor
	...
	kin_to_el_ratio = 0.1	//How much kinetic energy will be taken from turbine and converted into electricity
...
/obj/machinery/turbinemotor/updateConnection()
	turbine = null
	if(src.loc && anchored)
		turbine = locate(/obj/machinery/atmospherics/binary/pipeturbine) in get_step(src,dir)
