/obj/machinery/computer
	icon = 'mods/content/2020_the_cold_war/icons/machinery/computer.dmi'
	icon_state = "computer"
...
/obj/machinery/computer/on_update_icon()
	...
	if(reason_broken & MACHINE_BROKEN_NO_PARTS)
		set_light(0)
		icon = 'mods/content/2020_the_cold_war/icons/machinery/computer.dmi' //#FIXME: I really don't know why you'd do that after re-initializing it above.
		icon_state = "wired"
