...
/obj/screen/cinematic
	icon = 'mods/content/2020_the_cold_war/icons/effects/station_explosion.dmi'
...
/datum/universal_state/nuclear_explosion/OnEnter()
	...
	if(isStationLevel(T.z))
		...
		sound_to(world, sound('mods/content/2020_the_cold_war/sounds/ambience/shatter_the_empires_cinematic.ogg'))
...
/datum/universal_state/nuclear_explosion/start_cinematic_intro()
	for(var/mob/M in global.player_list) //I guess so that people in the lobby only hear the explosion
		sound_to(M, sound('mods/content/2020_the_cold_war/sounds/ambience/nuke_alarm.ogg'))
...
/datum/universal_state/nuclear_explosion/play_cinematic_station_destroyed()
	sound_to(world, sound('mods/content/2020_the_cold_war/sounds/misc/nuclear_explosion.ogg'))
...
/datum/universal_state/nuclear_explosion/play_cinematic_station_unaffected()
	...
	sleep(5)
	sound_to(world, sound('mods/content/2020_the_cold_war/sounds/misc/nuclear_explosion.ogg'))//makes no sense if you are on the station but whatever
