...
/decl/component/New(list/raw_args)
	parent = raw_args[1]
...
/decl/component/proc/_JoinParent()
	var/datum/P = parent
...
/decl/component/proc/RegisterWithParent()
	return

/decl/component/proc/Initialize(...)
	return

/decl/component/Destroy(force=FALSE, silent=FALSE)
	if(!force && parent)
		_RemoveFromParent()
	if(parent && !silent)
...
/decl/component/proc/_RemoveFromParent()
	var/datum/P = parent
	var/list/dc = P.datum_components
...
/decl/component/proc/UnregisterFromParent()
	return

/decl/proc/RegisterSignal(datum/target, sig_type_or_types, proctype, override = FALSE)
...
/decl/proc/UnregisterSignal(datum/target, sig_type_or_types)
	var/list/lookup = target.comp_lookup
...
/decl/component/proc/InheritComponent(datum/component/C, i_am_original)
	return

/decl/component/proc/CheckDupeComponent(datum/component/C, ...)
	return

/decl/component/proc/PreTransfer()
	return

/decl/component/proc/PostTransfer()
	return COMPONENT_INCOMPATIBLE //Do not support transfer by default as you must properly support it

/decl/component/proc/_GetInverseTypeList(our_type = type)
...
/decl/proc/_SendSignal(sigtype, list/arguments)
...
/decl/proc/GetComponent(datum/component/c_type)
	RETURN_TYPE(c_type)
...
/decl/proc/GetExactComponent(datum/component/c_type)
	RETURN_TYPE(c_type)
	if(initial(c_type.dupe_mode) == COMPONENT_DUPE_ALLOWED || initial(c_type.dupe_mode) == COMPONENT_DUPE_SELECTIVE)
		crash_with("GetComponent was called to get a component of which multiple copies could be on an object. This can easily break and should be changed. Type: \[[c_type]\]")
	var/list/dc = datum_components
...
/decl/proc/GetComponents(c_type)
	var/list/dc = datum_components
	if(!dc)
		return null
	. = dc[c_type]
...
/decl/proc/_AddComponent(list/raw_args)
...
/decl/proc/_LoadComponent(list/arguments)
	. = GetComponent(arguments[1])
	if(!.)
		return _AddComponent(arguments)

/decl/component/proc/RemoveComponent()
	if(!parent)
		return
...
/decl/proc/TakeComponent(datum/component/target)
...
/decl/proc/TransferComponents(datum/target)
	var/list/dc = datum_components
	if(!dc)
		return
