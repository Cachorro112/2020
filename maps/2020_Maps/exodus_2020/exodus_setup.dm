/datum/map/exodus/send_welcome()
	...
	if(exodus) //If the overmap is disabled, it's possible for there to be no exodus.
		...
		welcome_text += "Travel time to [company_name] Asteroid Belt Base:<br /><b>14 hours</b><br /><br>"
		welcome_text += "Time since last maintence visit:<br /><b>[rand(60,180)] days</b><br /><hr>"
