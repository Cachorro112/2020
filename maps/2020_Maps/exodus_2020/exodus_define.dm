/datum/map/exodus
	name          = "Gimini"
	full_name     = "NSS Gimini"
	path          = "exodus"

	station_name  = "NSS Gimini"
	station_short = "Gimini"
...
/datum/map/exodus/get_map_info()
	return "NSS Gimini was a research station, especially in the study of Phoron. After a few years, it was reproposed as a general station, but still maintaining a modern scientific department."
