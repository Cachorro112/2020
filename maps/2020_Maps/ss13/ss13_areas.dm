...
//Mining
/area/mining
	name = "\improper Asteroid Outpost Hallway"
	icon_state = "mining"
	area_flags = AREA_FLAG_RAD_SHIELDED
...
/area/mining/common
	name = "\improper Asteroid Outpost Common"
	icon_state = "mining_living"

/area/mining/engineering
	name = "\improper Asteroid Outpost Engineering"
	icon_state = "engineering"
	req_access = list(access_engine)

/area/mining/processing
	name = "\improper Asteroid Outpost Processing"
	icon_state = "mining_production"
	req_access = list(access_mining)

/area/mining/infermary
	name = "\improper Asteroid Outpost Infermary"
	icon_state = "medbay"

/area/mining/atmos
	name = "\improper Asteroid Outpost Atmos"
	icon_state = "atmos"
	req_access = list(access_atmospherics)

/area/mining/equip
	name = "\improper Asteroid Outpost Mining Gear"
	icon_state = "mining_eva"
	req_access = list(access_mining)

/area/mining/lab
	name = "\improper Asteroid Outpost Laboratory"
	icon_state = "research"
	req_access = list(access_research)

/area/mining/kitchen
	name = "\improper Asteroid Outpost Kitchen"
	icon_state = "kitchen"
